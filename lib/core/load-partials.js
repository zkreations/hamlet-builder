...
const printDuplicateConflicts = (title, items) => {
...
export const loadPartials = (input) => {
  ...
  printDuplicateConflicts(`\n${chalk.yellow('[Warning]')} Conflicts (duplicates):`, duplicates)
  printDuplicateConflicts(`\n${chalk.yellow('[Warning]')} Conflicts (folder duplicates):`, folderDuplicates)
...
export const loadPartialsInfo = (input) => {
  ...
  printList('Partials (normal):', normalPartials.sort())
  printList('Partials (folders):', folderPartials.sort())
  printDuplicateConflicts('Conflicts (duplicates):', duplicates)
  printDuplicateConflicts('Conflicts (folder duplicates):', folderDuplicates)
}
