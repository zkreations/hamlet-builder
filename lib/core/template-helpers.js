...
import { capitalize, getAsset } from '../utils.js'
...
// Custom switch-case-default helpers for Handlebars
// @param {String} value - The value to switch on
...
// Case helper for switch-case-default
// @param {String} value - The value to compare against the switch value
// @param {Object} options - Handlebars options object
...
// Custom default helper for switch-case-default
// @param {Object} options - Handlebars options object
...
// @param {...String} args - Strings to concatenate (last arg is Handlebars options, ignored)
// @return {String}
