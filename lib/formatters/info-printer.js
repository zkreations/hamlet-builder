...
function printSeparator() {
  console.warn(styleText('gray', '─'.repeat(50)))
  console.warn('')
}
...
function printHamletPartials(items) {
  console.warn(styleText('blue', `Partials (hamlet): ${items.length}`))
  console.warn('')
...
function printNormalPartialsByFolder(normalPartialsByFolder) {
  ...
  console.warn(styleText('blue', `Partials (normal): ${total}`))
  console.warn('')
...
function printFolderPartialsInfo(items) {
  console.warn(styleText('blue', `Partials (folders): ${items.length}`))
  console.warn('')
...
function printPluginPartials(pluginPartials) {
  ...
  console.warn(styleText('blue', `Partials (plugins): ${entries.length}`))
  console.warn('')
...
function printUnused(unused) {
  console.warn(styleText('blue', `Unused: ${unused.length}`) + styleText('gray', '  (Static analysis may not detect dynamic references)'))
  console.warn('')
...
export async function printPartialsInfo(options) {
  ...
  if (allDuplicates.length > 0) {
    printDuplicates(`${styleText('yellow', '[Warning]')} Conflicts:`, allDuplicates)
    printSeparator()
  }
