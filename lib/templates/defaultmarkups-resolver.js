...
export function resolveDocumentDefaultMarkups(template, options = {}) {
  ...
  // Process defaultmarkup elements (either all blocks if shouldMerge is true, or only the first block)
  ...
  // Replace first <b:defaultmarkups> with consolidatedXml, and remove subsequent blocks if shouldMerge is true
  let isFirst = true
