...
// Pick only primitive properties from an object
// @param {Object} object - The object to pick from
// @returns {Object} - The object with only primitive properties (string, number, boolean)
export function pickPrimitives(object) {
  const SUPPORTED_TYPES = new Set(['string', 'number', 'boolean'])

  return Object.fromEntries(Object.entries(object).filter(([, value]) =>
    SUPPORTED_TYPES.has(typeof value)))
}
